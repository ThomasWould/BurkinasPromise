<?php
/* Smarty version 3.1.30, created on 2018-04-12 07:19:37
  from "C:\MAMP\htdocs\burkinaspromise\html\templates\accedes-page.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5acf08893a58f8_61222204',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0bee7601223c9e0533ed09a77419b09f01369ed9' => 
    array (
      0 => 'C:\\MAMP\\htdocs\\burkinaspromise\\html\\templates\\accedes-page.tpl',
      1 => 1523517485,
      2 => 'file',
    ),
  ),
...
function content_5acf08893a58f8_61222204 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Submit a Message</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="message-page.php">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Submit Child Add Request</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="add-request-accedes.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">12 New Notifications</div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">13 New Sponsors</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
